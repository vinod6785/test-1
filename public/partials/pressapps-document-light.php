...
<div id="pado-main" class="pado-light<?php echo ($args['counter'] ? ' pado-counter' : ''); ?>">
    <div id="pado-sidebar">
        ...
        if ( isset( $pressapps_document_data['terms'] ) ) {
            ...
            foreach ( $pressapps_document_data['terms'] as $terms ) {
                ...
                ?>
                <ul>
                <li class="sidebar_cat_title pado-cat-<?php echo $terms->term_id; ?>" ><a class="pado_sidebar_cat_title" href="#cat-<?php echo $c; ?>"><?php echo $terms->name; ?></a></li>
                  ...
                  ?>
                    ...
                    <li class="<?php echo esc_attr( $sidebar_heading_class ); ?>"><a href="#document-<?php echo $p; ?>"><i class="<?php echo $this->document_icon(); ?>"></i> <?php echo $document->post_title; ?></a></li>
                    ...
                    <div id="pado-cat-<?php echo $terms->term_id; ?>" class="pado-section-enter">
                        ...
                        foreach ( $pressapps_document_data['document'][ $terms->term_id ] as $document ) {
                            ...
                            <article id="document-<?php echo $p; ?>" data-count="<?php echo $p; ?>" class="document type-pressapps_document status-publish clearfix">
                                <h3 class="<?php echo esc_attr( $post_heading_class ); ?> "><a href="#document-<?php echo $p; ?>" class="pado-sharing-link" title="<?php _e( 'Link to this page section', 'pressapps-document' ); ?>"><i class="si-link2"></i></a><a name="<?php echo $document->ID; ?>"></a><?php echo $document->post_title; ?></h3>
                                ...
                                ?>
                                <p class="pado-back-top"><a href="#top"><?php _e( 'Back To Top', 'pressapps-document' ); ?></a></p>
                            </article>
                        <?php
                    } ?>
                    </div>
